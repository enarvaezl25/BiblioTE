	...
	<ul class="breadcrumb breadcrumb-tabs">
	  	...
	  	<li>
	  		<a href="<?php echo SERVERURL; ?>categorysearch/" class="btn btn-primary">
	  			<i class="zmdi zmdi-search"></i> &nbsp; BUSCAR CATEGORÍA
	  		</a>
	  	</li>
	</ul>
</div>
...
<div class="container-fluid">
	<div class="panel panel-info">
		...
		<div class="panel-body">
			<form class="FormularioAjax" method="POST" action="<?php echo SERVERURL; ?>ajax/categoriaAjax.php" data-form="save" enctype="multipart/form-data" autocomplete="off">
		    	<fieldset>
