...
<div class="container-fluid">
	<div class="panel panel-info">
		...
		<div class="panel-body">
			<form class="FormularioAjax" method="POST" action="<?php echo SERVERURL; ?>ajax/administradorAjax.php" data-form="save" enctype="multipart/form-data" autocomplete="off">
		    	<fieldset>
		    			...
		    			<div class="row">
		    				<div class="col-xs-12">
						    	<div class="form-group label-floating">
								  	...
								  	<input pattern="[0-9-]{8,30}" class="form-control" type="text" name="dni-reg" required="" maxlength="30">
								</div>
		    				</div>
		    				...
		    				<div class="col-xs-12">
								<div class="form-group label-floating">
								  	...
								  	<input class="form-control" type="text" name="direccion-reg" maxlength="100">
								</div>
		    				</div>
		    			</div>
		    		</div>
		    		...
		    		<div class="container-fluid">
		    			<div class="row">
		    				...
		    				<div class="col-xs-12 col-sm-6">
								...
								<div class="radio radio-primary">
									<label>
										<input type="radio" name="optionsPrivilegio" value="<?php echo $lc->encryption(1); ?>">
								...
								<div class="radio radio-primary">
									<label>
										<input type="radio" name="optionsPrivilegio" value="<?php echo $lc->encryption(2); ?>">
								...
								<div class="radio radio-primary">
									<label>
										<input type="radio" name="optionsPrivilegio" value="<?php echo $lc->encryption(3); ?>" checked="">
