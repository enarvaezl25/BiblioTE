...
<div class="container-fluid">
	<form action="<?php echo SERVERURL; ?>ajax/buscadorAjax.php" class="FormularioAjax well" data-form="search" method="POST" enctype="multipart/form-data" autocomplete="off">
		...
		<div class="row">
			<input class="form-control" type="hidden" name="eliminar_busqueda_cliente" value="destruir" required="">
			<div class="col-xs-12">
				<p class="text-center">
	...
	<div class="panel panel-primary">
		...
		<div class="panel-body">
			<?php
				...
				echo $insClient->paginador_cliente_controlador($pagina[1],10,$_SESSION['privilegio_sbp'],$_SESSION['busqueda_cliente']);
			?>
		</div>
	</div>
</div>
