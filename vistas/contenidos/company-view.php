	...
	<div class="panel panel-info">
		...
		<div class="panel-body">
			<?php 
		        ...
		        if($CEm->rowCount()<=0):
		    ?>
			<form class="FormularioAjax" method="POST" action="<?php echo SERVERURL; ?>ajax/empresaAjax.php" data-form="save" enctype="multipart/form-data" autocomplete="off">
		    	<fieldset>
			...
			<div class="alert alert-dismissible alert-primary text-center">
				...
				<h4>¡Lo sentimos!</h4>
				<p>Ya existe una empresa registrada en el sistema, ya no se pueden agregar más. Para modificar datos diríjase a la opción “LISTA DE EMPRESAS”</p>
			</div>
		    <?php endif; ?>
		</div>
	</div>
