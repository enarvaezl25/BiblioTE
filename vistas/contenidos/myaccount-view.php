...
<div class="container-fluid">
	...
	<div class="panel panel-success">
		...
		<div class="panel-body">
			<form class="FormularioAjax" method="POST" action="<?php echo SERVERURL; ?>ajax/cuentaAjax.php" data-form="update" enctype="multipart/form-data" autocomplete="off">
		    			...
		    			<div class="row">
		    				...
		    				<div class="col-xs-12 col-sm-6">
								<div class="form-group">
									...
									<div class="radio radio-primary">
										<label>
											<input type="radio" name="optionsGenero-up" value="Masculino"  <?php if($campos['CuentaGenero']=="Masculino"){ echo 'checked=""'; } ?> >
											<i class="zmdi zmdi-male-alt"></i> &nbsp; Masculino
										</label>
									</div>
									<div class="radio radio-primary">
										<label>
											<input type="radio" name="optionsGenero-up" value="Femenino" <?php if($campos['CuentaGenero']=="Femenino"){ echo 'checked=""'; } ?> >
							...
							<div class="col-xs-12 col-sm-6">
								<div class="form-group">
									...
									<div class="radio radio-primary">
										<label>
											<input type="radio" name="optionsEstado-up" value="Activo" <?php if($campos['CuentaEstado']=="Activo"){ echo 'checked=""'; } ?> >
											<i class="zmdi zmdi-lock-open"></i> &nbsp; Activo
										</label>
									</div>
									<div class="radio radio-primary">
										<label>
											<input type="radio" name="optionsEstado-up" value="Deshabilitado" <?php if($campos['CuentaEstado']=="Deshabilitado"){ echo 'checked=""'; } ?> >
