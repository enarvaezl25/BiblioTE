	...
	<ul class="breadcrumb breadcrumb-tabs">
	  	...
	  	<li>
	  		<a href="<?php echo SERVERURL; ?>clientlist/" class="btn btn-success">
	  			<i class="zmdi zmdi-format-list-bulleted"></i> &nbsp; LISTA DE ESTUDIANTE
	  		</a>
	  	</li>
	  	<li>
...
<div class="container-fluid">
	<div class="panel panel-info">
		...
		<div class="panel-body">
			<form class="FormularioAjax" method="POST" action="<?php echo SERVERURL; ?>ajax/clienteAjax.php" data-form="save" enctype="multipart/form-data" autocomplete="off">
		    	<fieldset>
		    			...
		    			<div class="row">
		    				...
		    				<div class="col-xs-12">
								<div class="form-group label-floating">
								  	...
								  	<input class="form-control" type="text" name="direccion-reg" maxlength="150">
								</div>
		    				</div>
		    			</div>
		    		</div>
