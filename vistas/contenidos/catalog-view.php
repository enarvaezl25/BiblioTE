...
<div class="container-fluid">
	<div class="page-header">
	  <h1 class="text-titles"><i class="zmdi zmdi-inbox zmdi-hc-fw"></i>CATALOGO</h1>
	</div>
	<p class="lead">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Esse voluptas reiciendis tempora voluptatum eius porro ipsa quae voluptates officiis sapiente sunt dolorem, velit quos a qui nobis sed, dignissimos possimus!</p>
</div>
<div class="container-fluid text-center">
	<div class="btn-group">
      <a href="javascript:void(0)" class="btn btn-info btn-raised btn-lg "><i class="zmdi zmdi-labels"></i> &nbsp;SELECCIONE UNA CATEGORÍA</a>
      <a href="javascript:void(0)" data-target="dropdown-menu" class="btn btn-secondary btn-raised dropdown-toggle" data-toggle="dropdown"><span class="caret"></span></a>
...
<div class="container-fluid" style="min-height: 50vh;">
	...
	<p class="text-center" style="font-size: 300px; "><i class="zmdi zmdi-collection-bookmark"></i></p>
	<?php } ?>
</div>